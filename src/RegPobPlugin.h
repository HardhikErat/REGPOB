...
private:
    ...
    bool suppressScratchpadSync_ = false;
    ...
    void ArmScratchpadEdit(EuroScopePlugIn::CFlightPlan flightPlan, EditTarget target, const std::string& initialValue);
    void ClearScratchpadEdit(EuroScopePlugIn::CFlightPlan flightPlan);
